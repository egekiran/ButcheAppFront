          ...
          child: Column(
            ...
            children: [
              SizedBox(
                ...
                child: Container(
                  ...
                  margin: EdgeInsets.fromLTRB(size.width * 0.02,
                      size.height * 0.06, size.width * 0.02, 0),
                  child: Row(
              ...
              Row(
                ...
                children: [
                  Container(
                    margin: EdgeInsets.fromLTRB(size.width * 0,
                        size.height * 0.05, size.width * 0, size.height * 0.05),
                    child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Row(
                  ...
                  Container(
                    margin: EdgeInsets.fromLTRB(size.width * 0, size.height * 0,
                        size.width * 0, size.height * 0.01),
                                ...
                                children: [
                                  Row(
                                    children: [
                                      ...
                                      const SizedBox(
                                          width:
                                              4), // Decreased width for closer proximity
                                      Text(
